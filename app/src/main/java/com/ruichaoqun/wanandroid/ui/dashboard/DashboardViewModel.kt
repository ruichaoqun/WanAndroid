...
class DashboardViewModel @ViewModelInject constructor(private val dataRepository: DataRepository) : BaseListViewModel<SystemTreeBean>() {
    override suspend fun fetchList(): BaseResponse<MutableList<SystemTreeBean>> {
        return dataRepository.getSystemTree()
    }
